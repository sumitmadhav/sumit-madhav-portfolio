...
REPO_NAME_DEFAULT="sumit-madhav-portfolio"
...
echo "  2) Set custom domain (optional): Repo → Settings → Pages → Custom domain: yourdomain.com"
echo "  3) Enable 'Enforce HTTPS' once the certificate is issued."
echo
echo "If you have a domain, configure its DNS to point to GitHub Pages."
echo "See README_DEPLOY.md for example DNS records."
